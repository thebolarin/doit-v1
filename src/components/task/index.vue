          ...
          <div v-if="tasks.length > 0">
            ...
            >
              ...
              <div class="task">
                <h5>
                  <span>
                    <label>
                      ...
                      <span
                       class="truncate" style="font-size:13px;word-break: break-all;width:80%;color:#4A5568;font-weight:600;"
                      >{{task.title}}</span>
                    </label>
                  </span>
                ...
                <p>
                  <span>{{moment.parseZone(task.date).format('YYYY-MM-DD')}} | {{task.time}}</span>
